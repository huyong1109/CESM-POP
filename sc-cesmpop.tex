...
%\boldmath
  ...
  high-resolution (0.1\degree) barotropic solver by 4.7 times, from
  12.8s to 2.7s per simulation day, on 9,128 cores.  This improves the
  core POP simulation (without I/O and initialization) by 35\%, from
  6.0 to 8.10 simulated years per wall-clock day.  Further, to ensure
  that the use of an alternative solver in POP does not negatively
  impact the ocean climate, we use an ensemble-based statistical
  method to evaluate the impact of the new solver.
\end{abstract}
